...
EXTRA = {
    'es': dict(strings={'album_hint': 'Un amigo nuevo cada 10 rondas', 'friend_hidden_title': '¿Quién soy?'},
               plurals={'one': '%1$d ronda más y nos conocemos', 'other': '%1$d rondas más y nos conocemos'}),
    'pt-rBR': dict(strings={'album_hint': 'Um amigo novo a cada 10 rodadas', 'friend_hidden_title': 'Quem sou eu?'},
                   plurals={'one': 'Mais %1$d rodada e nos conhecemos', 'other': 'Mais %1$d rodadas e nos conhecemos'}),
    'fr': dict(strings={'album_hint': 'Un nouvel ami toutes les 10 manches', 'friend_hidden_title': 'Qui suis-je ?'},
               plurals={'one': 'Encore %1$d manche et on se rencontre', 'other': 'Encore %1$d manches et on se rencontre'}),
    'de': dict(strings={'album_hint': 'Alle 10 Runden ein neuer Freund', 'friend_hidden_title': 'Wer bin ich?'},
               plurals={'one': 'Noch %1$d Runde, dann treffen wir uns', 'other': 'Noch %1$d Runden, dann treffen wir uns'}),
    'it': dict(strings={'album_hint': 'Un nuovo amico ogni 10 turni', 'friend_hidden_title': 'Chi sono?'},
               plurals={'one': 'Ancora %1$d turno e ci incontriamo', 'other': 'Ancora %1$d turni e ci incontriamo'}),
    'ru': dict(strings={'album_hint': 'Новый друг каждые 10 раундов', 'friend_hidden_title': 'Кто я?'},
    ...
    'uk': dict(strings={'album_hint': 'Новий друг кожні 10 раундів', 'friend_hidden_title': 'Хто я?'},
    ...
    'pl': dict(strings={'album_hint': 'Nowy przyjaciel co 10 rund', 'friend_hidden_title': 'Kim jestem?'},
    ...
    'nl': dict(strings={'album_hint': 'Elke 10 rondes een nieuwe vriend', 'friend_hidden_title': 'Wie ben ik?'},
               plurals={'one': 'Nog %1$d ronde en we ontmoeten elkaar', 'other': 'Nog %1$d rondes en we ontmoeten elkaar'}),
    'tr': dict(strings={'album_hint': 'Her 10 turda yeni bir arkadaş', 'friend_hidden_title': 'Ben kimim?'},
               plurals={'one': '%1$d tur daha, sonra tanışırız', 'other': '%1$d tur daha, sonra tanışırız'}),
    'ar': dict(strings={'album_hint': 'صديق جديد كل 10 جولات', 'friend_hidden_title': 'من أنا؟'},
    ...
    'hi': dict(strings={'album_hint': 'हर 10 राउंड पर एक नया दोस्त', 'friend_hidden_title': 'मैं कौन हूँ?'},
               plurals={'one': 'बस %1$d राउंड और, फिर मिलेंगे', 'other': 'बस %1$d राउंड और, फिर मिलेंगे'}),
    'id': dict(strings={'album_hint': 'Teman baru setiap 10 ronde', 'friend_hidden_title': 'Siapa aku?'},
               plurals={'other': '%1$d ronde lagi dan kita bertemu'}),
    'vi': dict(strings={'album_hint': 'Cứ 10 vòng có một bạn mới', 'friend_hidden_title': 'Tớ là ai?'},
               plurals={'other': 'Thêm %1$d vòng nữa là gặp tớ'}),
    'th': dict(strings={'album_hint': 'เพื่อนใหม่ทุก 10 รอบ', 'friend_hidden_title': 'ฉันคือใคร'},
               plurals={'other': 'อีก %1$d รอบก็ได้เจอกัน'}),
    'ja': dict(strings={'album_hint': '10ラウンドごとに あたらしい なかま', 'friend_hidden_title': 'だれかな？'},
               plurals={'other': 'あと %1$d ラウンドで あえるよ'}),
    'ko': dict(strings={'album_hint': '10라운드마다 새 친구', 'friend_hidden_title': '나는 누구일까?'},
               plurals={'other': '%1$d라운드만 더 하면 만나요'}),
    'zh-rTW': dict(strings={'album_hint': '每 10 關多一位新朋友', 'friend_hidden_title': '我是誰？'},
                   plurals={'other': '再玩 %1$d 關就能見到我'}),
    'zh-rCN': dict(strings={'album_hint': '每 10 关多一位新朋友', 'friend_hidden_title': '我是谁？'},
                   plurals={'other': '再玩 %1$d 关就能见到我'}),
    'ms': dict(strings={'album_hint': 'Kawan baru setiap 10 pusingan', 'friend_hidden_title': 'Siapa saya?'},
